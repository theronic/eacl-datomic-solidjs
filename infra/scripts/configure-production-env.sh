...

{
  ...
  echo EACL_DATAHIKE_DEMO_LMDB_PATH=/var/lib/eacl-datahike-demo/lmdb
  echo EACL_DATAHIKE_DEMO_LMDB_MAP_SIZE=8589934592
  echo EACL_DATAHIKE_DEMO_DATAHIKE_STORE_CACHE_SIZE=1000
  ...
  echo EACL_DATAHIKE_DEMO_SEED_TRANSACTION_SIZE=1000
  echo EACL_DATAHIKE_DEMO_SEED_PAUSE_MS=0
  echo EACL_DATAHIKE_DEMO_SEED_IN_FLIGHT=2
